...
artifacts.llmsTxt = withSourceLinks(artifacts.llmsTxt, manifest, "extfn", config.site?.canonicalUrl);
artifacts.llmsFullTxt = withSourceLinks(artifacts.llmsFullTxt, manifest, "extfn", config.site?.canonicalUrl);

...
export interface MdfnEditorShellProps extends MdfnEditorProps { readonly toolbarGroups?: readonly ToolbarGroup[]; readonly hideToolbar?: boolean; readonly hideAuthoringChrome?: boolean; readonly actor?: EditorialActor; readonly onSelectFiles?: (files: readonly File[]) => Promise<MarkdownUploadResult>; readonly onModeChange?: (mode: EditorMode) => void; readonly versions?: readonly AuthoringVersion[]; readonly onRestoreVersion?: (version: number) => void | Promise<void>; }
  ...
  return <div class={props.class} data-mdfn-component="editor-shell">
    ...
    <MdfnEditor
      ...
      onFiles={async (files) => {
        ...
        try {
          await insertUploadedMarkdown(insertion, Promise.resolve(props.onSelectFiles?.(files)));

...
artifacts.llmsTxt = withSourceLinks(artifacts.llmsTxt, manifest, "mdfn", config.site?.canonicalUrl);
artifacts.llmsFullTxt = withSourceLinks(artifacts.llmsFullTxt, manifest, "mdfn", config.site?.canonicalUrl);

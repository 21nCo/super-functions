...
validate both Markdown and the complete sidecar and run atomically. Update,
restore, and editorial writes support idempotency through the `Idempotency-Key`
header or request body; document creation does not. Delete atomically removes the

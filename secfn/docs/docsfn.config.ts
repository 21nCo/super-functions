...
const config: DocsConfig = {
  ...
  site: {
    ...
    basePath: "/docs",
    editLink: { pattern: "https://github.com/21nCo/super-functions/edit/dev/secfn/docs/{path}" },
  },
  compat: { preset: "none" },
  content: {
    root: ".",
  ...
  navigation: {
    topNav: [
      ...
      { label: "GitHub", href: "https://github.com/21nCo/super-functions/tree/dev/secfn", external: true },
    ],
    sidebars: {

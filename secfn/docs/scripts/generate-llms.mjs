...
artifacts.llmsTxt = withSourceLinks(artifacts.llmsTxt, manifest, "secfn", config.site?.canonicalUrl);
artifacts.llmsFullTxt = withSourceLinks(artifacts.llmsFullTxt, manifest, "secfn", config.site?.canonicalUrl);

...
artifacts.llmsTxt = withSourceLinks(artifacts.llmsTxt, manifest, "authfn", config.site?.canonicalUrl);
artifacts.llmsFullTxt = withSourceLinks(artifacts.llmsFullTxt, manifest, "authfn", config.site?.canonicalUrl);

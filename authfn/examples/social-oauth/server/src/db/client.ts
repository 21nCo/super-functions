...
import { socialOAuthSchema } from '../auth.js';

const DEFAULT_DATABASE_URL = 'postgres://postgres:postgres@127.0.0.1:5432/authfn_examples_social_oauth';

const dateFieldsByModel = new Map<string, string[]>(
  socialOAuthSchema.schemas.map((table) => [
    table.modelName,
...
export interface SocialOAuthDatabase {
  adapter: Adapter;
...
export function createSocialOAuthDatabase(

...
[ADR-0001](https://github.com/21nCo/super-functions/blob/dev/mcpfn/ADR-0001-COMPATIBILITY.md)
for the compatibility policy.

See the [architecture](https://github.com/21nCo/super-functions/blob/dev/mcpfn/ARCHITECTURE.md), [testing guide](https://github.com/21nCo/super-functions/blob/dev/mcpfn/TESTING.md), and runnable [calculator example](https://github.com/21nCo/super-functions/blob/dev/mcpfn/examples/calculator-server.ts).

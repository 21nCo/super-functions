...
export const searchFnAdminActions = [
  {
    ...
    resource: "documents",
    title: "Index",
    description: "Index one document by resource:id. Use resource:number:<id> for numeric IDs and resource:string:<id> to escape a string ID beginning with number:.",
  ...
  },
  {
    ...
    description: "Remove one document by resource:id. Use resource:number:<id> for numeric IDs and resource:string:<id> to escape a string ID beginning with number:.",

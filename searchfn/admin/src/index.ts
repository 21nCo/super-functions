...
export const searchFnAdminActions = [
  {
    ...
    resource: "documents",
    title: "Index",
    description: "Index one document by resource:id. Use resource:number:<id> for numeric IDs and resource:string:<percent-encoded-id> for arbitrary string IDs.",
  ...
  },
  {
    ...
    description: "Remove one document by resource:id. Use resource:number:<id> for numeric IDs and resource:string:<percent-encoded-id> for arbitrary string IDs.",

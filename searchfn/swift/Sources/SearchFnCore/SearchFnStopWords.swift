...
let searchFnStopWordsEnglish: Set<String> = [
    "a", "an", "and", "are", "as", "at", "be", "but", "by", "for", "if", "in", "into",
    "is", "it", "no", "not", "of", "on", "or", "such", "that", "the", "their", "then",
    "there", "these", "they", "this", "to", "was", "will", "with",
]

let searchFnStopWordsSpanish: Set<String> = [
    ...
    "seguir", "menos", "nuevo", "encontrar", "algo", "solo", "salir", "volver", "tomar",
    ...
    "acabar", "mil", "against", "durante",
]

let searchFnStopWordsFrench: Set<String> = [
    ...
    "fusses", "fût", "fussions", "fussiez", "fussent", "ayant", "eu", "eue", "eues", "eus",

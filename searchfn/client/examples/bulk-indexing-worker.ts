...
async function main() {
  ...
  const speedupVsOld = addBulkTime > 0 ? (oldApproachTime / addBulkTime).toFixed(1) : "N/A";
  console.log(`Speedup: ${speedupVsOld}${speedupVsOld === "N/A" ? "" : "x"} faster with batched persistence\n`);

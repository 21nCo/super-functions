...
The [Python source guide](https://github.com/21nCo/super-functions/blob/dev/plugfn/python/README.md) shows its setup shape. Check the [readiness matrix](/docs/reference/readiness)'s Python column for each provider and avoid assuming parity with TypeScript.

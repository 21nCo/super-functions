...
description: Install docsfn, create a minimal site, and understand how content maps to URLs.
---

# Getting Started

**docsfn** is a self-hosted documentation toolchain for the superfunctions ecosystem. You define a `docsfn.config.ts`, write Markdown under a content directory, and wire framework adapters (**SvelteKit** or **Next.js**) to serve pages, sidebars, search, and blog posts.

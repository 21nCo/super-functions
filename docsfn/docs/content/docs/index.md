---
title: docsfn Documentation
description: Overview of the docsfn documentation toolchain and how to use this site.
---

# docsfn Documentation

**docsfn** is the documentation framework used across superfunctions: filesystem-backed Markdown, a typed config file, manifest + search artifacts, and first-class adapters for **SvelteKit** and **Next.js**.

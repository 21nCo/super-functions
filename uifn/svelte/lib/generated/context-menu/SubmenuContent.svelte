<script lang="ts">
  import type { ContextMenuController } from '@uifn/core/primitives/context-menu';
  ...
  type Props = SveltePrimitivePartProps<ContextMenuController['parts']['submenuContent'], 'div', true>;
  let {
    value,
    forceMount = false,
    container,

<script lang="ts">
  import type { NumberInputController } from '@uifn/core/primitives/number-input';
  ...
  type Props = SveltePrimitivePartProps<NumberInputController['parts']['decrement'], 'button', false>;
  let {
    value,
    forceMount = false,
    container,

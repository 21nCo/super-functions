<script lang="ts">
  import type { CollapsibleController } from '@uifn/core/primitives/collapsible';
  ...
  type Props = SveltePrimitivePartProps<CollapsibleController['parts']['trigger'], 'button', false>;
  let {
    value,
    forceMount = false,
    container,

<script lang="ts">
  import type { CarouselController } from '@uifn/core/primitives/carousel';
  ...
  type Props = SveltePrimitivePartProps<CarouselController['parts']['indicatorGroup'], 'div', false>;
  let {
    value,
    forceMount = false,
    container,

<script lang="ts">
  import type { AngleSliderController } from '@uifn/core/primitives/angle-slider';
  ...
  type Props = SveltePrimitivePartProps<AngleSliderController['parts']['hiddenInput'], 'input', false>;
  let {
    value,
    forceMount = false,
    container,

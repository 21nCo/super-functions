<script lang="ts">
  import type { DatePickerController } from '@uifn/core/primitives/date-picker';
  ...
  type Props = SveltePrimitivePartProps<DatePickerController['parts']['hiddenInput'], 'input', false>;
  let {
    value,
    forceMount = false,
    container,

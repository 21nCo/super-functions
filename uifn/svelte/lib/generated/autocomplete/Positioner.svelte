<script lang="ts">
  import type { AutocompleteController } from '@uifn/core/primitives/autocomplete';
  ...
  type Props = SveltePrimitivePartProps<AutocompleteController['parts']['positioner'], 'div', false>;
  let {
    value,
    forceMount = false,
    container,

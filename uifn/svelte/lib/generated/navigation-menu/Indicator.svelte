<script lang="ts">
  import type { NavigationMenuController } from '@uifn/core/primitives/navigation-menu';
  ...
  type Props = SveltePrimitivePartProps<NavigationMenuController['parts']['indicator'], 'div', false>;
  let {
    value,
    forceMount = false,
    container,

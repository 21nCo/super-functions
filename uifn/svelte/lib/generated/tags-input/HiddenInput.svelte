<script lang="ts">
  import type { TagsInputController } from '@uifn/core/primitives/tags-input';
  ...
  type Props = SveltePrimitivePartProps<TagsInputController['parts']['hiddenInput'], 'input', true>;
  let {
    value,
    forceMount = false,
    container,

<script lang="ts">
  import type { FloatingPanelController } from '@uifn/core/primitives/floating-panel';
  ...
  type Props = SveltePrimitivePartProps<FloatingPanelController['parts']['resizeHandle'], 'div', true>;
  let {
    value,
    forceMount = false,
    container,

<script lang="ts">
  import type { PaginationController } from '@uifn/core/primitives/pagination';
  ...
  type Props = SveltePrimitivePartProps<PaginationController['parts']['previous'], 'button', false>;
  let {
    value,
    forceMount = false,
    container,

<script lang="ts">
  import type { ImageCropperController } from '@uifn/core/primitives/image-cropper';
  ...
  type Props = SveltePrimitivePartProps<ImageCropperController['parts']['zoomControl'], 'input', false>;
  let {
    value,
    forceMount = false,
    container,

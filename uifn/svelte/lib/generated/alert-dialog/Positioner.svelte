<script lang="ts">
  import type { AlertDialogController } from '@uifn/core/primitives/alert-dialog';
  ...
  type Props = SveltePrimitivePartProps<AlertDialogController['parts']['positioner'], 'div', false>;
  let {
    value,
    forceMount = false,
    container,

...
function colorVars(preset: UIFnPresetV1, mode: 'light' | 'dark'): Record<string, string> {
  ...
  const byMode = <T>(light: T, dark: T): T => mode === 'dark' ? dark : light;
  const byContrast = <T>(normal: T, contrasting: T): T => high ? contrasting : normal;
  const accentHue = hue;
  const accentChroma = byContrast(0.18 + shift.chroma, Math.max(chroma, 0.16));
  const textPrimary = byMode(oklch(byContrast(0.2, 0.12), Math.min(chroma, 0.024), hue), oklch(byContrast(0.95, 0.98), Math.min(chroma, 0.012), hue));
  const canvas = byMode(oklch(byContrast(0.98, 1), Math.min(chroma, 0.014), hue), oklch(byContrast(0.15, 0.08), Math.min(chroma, 0.02), hue));
  const accentSolid = solidColor(byMode(byContrast(0.55, 0.46), byContrast(0.68, 0.78)), accentChroma, accentHue);
  ...
  return {
      ...
      '--uifn-color-surface-raised': byMode(oklch(1, Math.min(chroma, 0.008), hue), oklch(byContrast(0.2, 0.12), Math.min(chroma, 0.022), hue)),
      '--uifn-color-surface-sunken': byMode(oklch(byContrast(0.94, 0.92), Math.min(chroma, 0.016), hue), oklch(byContrast(0.11, 0.05), Math.min(chroma, 0.018), hue)),
      '--uifn-color-surface-overlay': byMode(oklch(0.99, Math.min(chroma, 0.01), hue), oklch(byContrast(0.24, 0.16), Math.min(chroma, 0.024), hue)),
      '--uifn-color-surface-depth-0': canvas,
      '--uifn-color-surface-depth-1': byMode(oklch(0.96, Math.min(chroma, 0.016), hue), oklch(0.18, Math.min(chroma, 0.022), hue)),
      '--uifn-color-surface-depth-2': byMode(oklch(0.94, Math.min(chroma, 0.018), hue), oklch(0.21, Math.min(chroma, 0.024), hue)),
      '--uifn-color-surface-depth-3': byMode(oklch(0.92, Math.min(chroma, 0.02), hue), oklch(0.24, Math.min(chroma, 0.026), hue)),
      '--uifn-color-surface-depth-4': byMode(oklch(0.9, Math.min(chroma, 0.022), hue), oklch(0.27, Math.min(chroma, 0.028), hue)),
      '--uifn-color-text-primary': textPrimary,
      '--uifn-color-text-secondary': byMode(oklch(0.35, Math.min(chroma, 0.024), hue), oklch(0.82, Math.min(chroma, 0.014), hue)),
      '--uifn-color-text-muted': byMode(oklch(0.5, Math.min(chroma, 0.018), hue), oklch(0.7, Math.min(chroma, 0.014), hue)),
      '--uifn-color-text-disabled': byMode(oklch(0.55, Math.min(chroma, 0.012), hue), oklch(0.54, Math.min(chroma, 0.012), hue)),
      '--uifn-color-border-subtle': byMode(oklch(byContrast(0.88, 0.72), Math.min(chroma, 0.012), hue), oklch(byContrast(0.28, 0.4), Math.min(chroma, 0.018), hue)),
      '--uifn-color-border-default': byMode(oklch(byContrast(0.78, 0.58), Math.min(chroma, 0.014), hue), oklch(byContrast(0.38, 0.52), Math.min(chroma, 0.02), hue)),
      '--uifn-color-border-strong': byMode(oklch(0.58, Math.min(chroma, 0.016), hue), oklch(0.54, Math.min(chroma, 0.022), hue)),
      '--uifn-color-accent-solid': accentSolid,
      '--uifn-color-accent-subtle': byMode(oklch(0.93, 0.05, accentHue), oklch(0.24, 0.05, accentHue)),
      '--uifn-color-accent-contrast': contrastOn(byMode(byContrast(0.55, 0.46), byContrast(0.68, 0.78)), accentChroma, accentHue),
      '--uifn-color-danger-solid': solidColor(byMode(0.5, 0.68), 0.19, 25),
      '--uifn-color-danger-subtle': byMode('oklch(94% 0.04 25)', 'oklch(24% 0.05 25)'),
      '--uifn-color-danger-contrast': contrastOn(byMode(0.5, 0.68), 0.19, 25),
      '--uifn-color-warning-solid': solidColor(byMode(0.64, 0.76), 0.16, 80),
      '--uifn-color-warning-subtle': byMode('oklch(94% 0.05 80)', 'oklch(24% 0.06 80)'),
      '--uifn-color-warning-contrast': contrastOn(byMode(0.64, 0.76), 0.16, 80),
      '--uifn-color-success-solid': solidColor(byMode(0.48, 0.68), 0.14, 145),
      '--uifn-color-success-subtle': byMode('oklch(93% 0.04 145)', 'oklch(24% 0.05 145)'),
      '--uifn-color-success-contrast': contrastOn(byMode(0.48, 0.68), 0.14, 145),

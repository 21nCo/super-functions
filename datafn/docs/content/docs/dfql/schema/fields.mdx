...
mutation validation does not currently enforce every constraint, including
enum membership, bounds, and patterns. Check the selected storage adapter
before relying on those constraints at runtime.

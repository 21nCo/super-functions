...
const browserOutput = process.env.UIFN_PHASE07_BROWSER_OUTPUT
  ?? path.resolve('uifn/.conduct/evidence/phase-07/browser-latest');
const commands = [
  ...
  [process.execPath, ['--test','scripts/verify-uifn-phase-07-contract.test.mjs']],
  [process.execPath, ['scripts/verify-uifn-phase-07-contract.mjs','--require-dist']],
  [process.execPath, ['scripts/generate-uifn-phase-07.mjs','--check']],
  [process.execPath, ['scripts/verify-uifn-overlay-pack.mjs']],
  ['npm', ['--workspace','@uifn/dom','run','test:browser'], { UIFN_PHASE07_BROWSER_OUTPUT: browserOutput }],

<script lang="ts">
  interface Props {
    ...
    quickLinks: { label: string; href: string; blurb: string }[];
  }
  let { name, siteTitle, description, tagline, features, quickLinks }: Props = $props();
  let extraBlurb = $derived(description && description !== tagline ? description : "");
</script>
...
<div class="landing docsfn-layout">
  <section class="landing-hero" aria-labelledby="landing-title">
    ...
    <h1 id="landing-title" class="landing-title">{name}</h1>

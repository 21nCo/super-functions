...
export const mailFnAdminResources = [
  ...
  },
  {
    ...
    risk: "sensitive",
    idField: "id",
    displayFields: ["id", "subject", "status", "receivedAt"],
    searchableFields: ["id", "subject", "envelopeFrom", "envelopeTo", "status"],
    filterableFields: [
      "status", "inboxId", "threadId", "readAt", "receivedAt", "createdAt", "updatedAt",
      "sender", "senderDomain", "recipient", "subject", "text", "receivedAfter", "receivedBefore",
      "unreadOnly", "labels",
    ],
    sortableFields: ["receivedAt", "createdAt", "updatedAt", "subject", "sizeBytes", "status"],
    sensitiveFields: [
      "secret",
      "token",
      "credential",
  ...
  },
  {
    ...
    risk: "sensitive",
    idField: "id",
    displayFields: ["id", "filename", "contentType", "sizeBytes", "createdAt"],
    searchableFields: ["id", "filename", "contentType", "sha256"],
    filterableFields: ["contentType", "inboxId", "messageId", "createdAt"],
